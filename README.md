...
### 💡 주요 지표 설명: 소비자심리지수 (CCSI)
- **정의**: 소비자들이 경제 상황을 어떻게 느끼는지 보여주는 '경제 온도계'입니다.
- **해석**: 
  - **100 초과**: 과거 평균보다 경제를 낙관적으로 봄 (소비 증가 가능성)
  - **100 미만**: 과거 평균보다 경제를 비관적으로 봄 (지갑을 닫을 가능성)
- **역할**: 실제 통계가 나오기 전 경기 흐름을 미리 예측하는 선행 지표입니다.
